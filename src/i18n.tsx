...
const messages = {
  ja: {
    ...
    details: "詳細", unsupportedFormat: "{type} はサポートされていない形式です。対応形式：{formats}", fileSelectError: "ファイル選択エラー: {error}",
    ...
    error_input_file_not_found: "入力ファイルが存在しません", error_temp_dir_creation_failed: "一時ディレクトリの作成に失敗しました。",
    error_timestamp_fetch_failed: "タイムスタンプの取得に失敗しました。", error_ffmpeg_unavailable: "変換エンジンを起動できませんでした。",
    error_ffmpeg_start_failed: "変換エンジンを開始できませんでした。", error_conversion_failed: "変換処理に失敗しました。",
    error_output_file_not_generated: "出力ファイルの作成に失敗しました", error_probe_failed: "元のサイズを取得できませんでした。",
  ...
  en: {
    ...
    details: "Details", unsupportedFormat: "{type} is not supported. Supported formats: {formats}", fileSelectError: "File selection error: {error}",
    ...
    error_input_file_not_found: "Cound not find the input file", error_temp_dir_creation_failed: "Failed to create a temporary directory",
    error_timestamp_fetch_failed: "Failed to fetch timestamp", error_ffmpeg_unavailable: "Could not start the conversion engine.",
    error_ffmpeg_start_failed: "Could not start the conversion engine.", error_conversion_failed: "Conversion failed.",
    error_output_file_not_generated: "Failed to generate the output file", error_probe_failed: "Could not read source dimensions.",
